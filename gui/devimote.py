...
'''An unofficial Kivy remote control application for Devialet Expert amplifiers.

This is a standalone script, not part of the published library. It consumes the
``pydevialet_expert_nonpro`` package for all amplifier communication. Run it with
``python gui/devimote.py`` after installing the project with the ``gui`` extra.
'''
